 ...
 */
    ...
    public void excelWriteTest() throws IOException {
        ...
        Workbook workbook = WorkbookFactory.create(new FileInputStream(dosyaYolu));
        ...
        sheet1.getRow(5).createCell(2).setCellValue(43000);
        sheet1.getRow(5).createCell(2).setBlank();//Hücreye boş değer atar yada varsa siler

        FileOutputStream fos = new FileOutputStream("src/test/java/resources/Capitals.xlsx");
        workbook.write(fos);//Workbook hafizasina alinan veriyi  "src/test/java/resources/Capitals.xlsx"
