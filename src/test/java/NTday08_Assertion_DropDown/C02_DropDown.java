package NTday08_Assertion_DropDown;
...
public class C02_DropDown {
    ...
    public void test02() {
      ...
      //  a. Tüm eyalet isimlerini yazdıralım
        ...
        state.forEach(t-> System.out.println(t.getText()));
        /*
    ...
    public void test03() {
        ...
        WebElement tumEyaletler = driver.findElement(By.cssSelector("select[id='state'"));
        Select select = new Select(tumEyaletler);
        String lastSelectedText = select.getFirstSelectedOption().getText();
        Assert.assertEquals(lastSelectedText,"Select a State");
    }
}
